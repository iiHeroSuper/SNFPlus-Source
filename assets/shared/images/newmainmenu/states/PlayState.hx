...
class PlayState extends MusicBeatState
{
	...
	public function startVideo(name:String, forMidSong:Bool = false, canSkip:Bool = true, loop:Bool = false, playOnLoad:Bool = true)
	{
		...
		if (foundFile)
		{
			...
			// REMOVED: videoCutscene.videoSprite.play();
			// The VideoSprite constructor already starts the video playback.
			// Calling .play() again without arguments causes an error in hxCodec.
