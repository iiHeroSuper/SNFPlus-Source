...
function onCreate()
	...
	makeAnimatedLuaSprite('ghz-flower1', path..'purpflower', 120, 500)
	addAnimationByPrefix('ghz-flower1', 'flower', 'bouncy flower', 24, true)
	objectPlayAnimation('ghz-flower1', 'flower')
	scaleObject('ghz-flower1', 1.3, 1.3);
	--setLuaSpriteScrollFactor('ghz-flower1', 1, 1);
	
	makeAnimatedLuaSprite('ghz-flower2', path..'sunflower', 1300, 500)
	addAnimationByPrefix('ghz-flower2', 'flower', 'sunflower', 24, true)
	objectPlayAnimation('ghz-flower2', 'flower')
	scaleObject('ghz-flower2', 1.3, 1.3);
	--setLuaSpriteScrollFactor('ghz-flower1', 1, 1);
	
	makeLuaSprite('ghz-tree', path..'tree bfdi', 535, 185);
	scaleObject('ghz-tree', 1.3, 1.3);
	...
	addLuaSprite('ghz-flower1', false);
	addLuaSprite('ghz-flower2', false);
	addLuaSprite('ghz-tree', false);
