...
class Achievements {
	public static function init()
	{
		...
		createAchievement('week9_nomiss',			{name: "Ok Showoff..", description: "Beat Week 9 with no Misses."});
		createAchievement('week10_nomiss',			{name: "Every Hedgehog Hates You", description: "Beat Week 10 with no Misses."});
