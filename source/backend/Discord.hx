...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'In the Menus i think uhhmmg,,,', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
